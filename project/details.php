...
<div class="bg-light container-fluid mt-5">
    <h3>Numer telefonu: 654234754</h3>
    <h3>E-mail: BuonViaggio@gmail.com</h3>
</div>
<div class="mt-5"></div>
<div class="bg-light container-fluid mb-5">
...
<div class="bg-light container-fluid mt-5">
    <h3>Naszym celem jest być wiodącym biurem podróży, które nie tylko oferuje standardowe usługi turystyczne, ale także staje się zaufanym doradcą, który rozumie indywidualne potrzeby i preferencje swoich klientów. Dążymy do zapewnienia wyjątkowej obsługi klienta oraz spersonalizowanych rozwiązań, które sprawiają, że każda podróż staje się unikalną przygodą.</h3>>
</div>
